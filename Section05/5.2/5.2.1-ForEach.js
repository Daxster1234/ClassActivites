...
data.forEach((arr) => console.log(arr.address.city));
// create an array of latitude and longitude coordinate pairs
let latLong = [];
data.forEach((arr) => latLong.push([arr.address.geo.lat, arr.address.geo.lng]));
console.log(latLong)
// create an array of strings that combine the company's catchPhrase and bs
let strArr = [];
data.forEach((arr) => {
  let str = arr.company.catchPhrase.concat(" ", arr.company.bs);
  strArr.push(str);
});
console.log(strArr)
